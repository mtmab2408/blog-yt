...
function Search() {
  ...
  return (
    <div className='flex justify-center flex-col px-[70] md:px-[150px]'>
      ...
      <div className='bg-white shadow-lg p-3 rounded-lg -mt-5 mx-[25%] flex items-center'>
        ...
        <input type="text" placeholder='Search' name="" id="" className='outline-none ml-2 placeholder-gray-400'/>
      </div>
